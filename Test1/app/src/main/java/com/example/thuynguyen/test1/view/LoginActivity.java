...
import com.example.thuynguyen.test1.control.Login;
...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public void setListAc(List<UserAccount> list){
        this.list = list;
        Toast.makeText(LoginActivity.this, "thuy "+list.size(), Toast.LENGTH_SHORT).show();
    }
}
